...
<div class="imagefit">
	<section>
		<div class="form-container">
			<h1 class="header1" style="font-family: Baskerville, 'Palatino Linotype', Palatino, 'Century Schoolbook L', 'Times New Roman', 'serif'">- New Blog -</h1>
			<form action="write_blogs_handler.php" method="post" enctype="multipart/form-data">
				<div class="control">
					...
					<input type="text" name="title1" id="title1" placeholder="Enter Blog Title.."><br>
				</div>
                <div class="control">
					<label style="font-size: 18px" for="desc">Description: </label><br><br>
					<input name="desc" id="desc" placeholder="Write Blog Description.."></input>
				</div>
				<div class="control">
					<label style="font-size: 18px" for="content">Content: </label><br><br>
					<textarea name="content" id="content" placeholder="Write Blog.."></textarea>
				</div>
				<div class="control">
				...
				<div class="control"><br>
					<p align="center"><input type="submit" value="Post Blog" id="btnevent" name="btnevent"></p>
				</div>
			</form>
		</div>
	</section>
